# Getting started — Brochures-Template
...
- "Create a product brochure for [product/module]"
- "Build a brochure with cover, benefits, platform, two feature spreads, expert spread, and back cover"

**Edit an existing brochure:**
- "Add a new feature spread to [brochure-name]"
- "Update the headline on the platform spread of [brochure-name]"
- "Change the cover badge on [brochure-name]"

**Generate a PDF:**
- "Render [brochure-name] to PDF"
